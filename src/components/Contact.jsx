...
export default function Contact() {
  return (
    <div name='contact' className='w-full p-4 text-white bg-gradient-to-b from-black to-gray-800'>
      <div className='flex flex-col justify-center h-full max-w-screen-lg p-4 mx-auto pt-[150px]'>
        <div className='pb-8'>
        ...
        <div className='flex items-center justify-center'>
          <form
            autoComplete='off'
            action='https://getform.io/f/60b97f43-5e3b-4745-be17-5b26bc789666'
            method='POST'
          ...
          >
            ...
            <input
              ...
              className='p-2 mb-4 text-white bg-transparent border-2 rounded-md focus:outline-none'
            />
            <textarea
              name='message'
